  ...
  _createClass(Main, {
    render: {
      value: function render() {
        ...
        for (var h = 0; h < 24; h++) {
          hourMarkers.push(React.createElement("div", { className: "c-Availability__Hour",
            style: {
              left: "" + h * ratio + "%" } }));
        }

        return React.createElement("div", { className: "c-Main" }, React.createElement(LocalTime, { time: today }), React.createElement("div", { className: "c-Availability" }, React.createElement("div", { className: "c-Availability__People" }, this.state.people.map(function (person) {
          return React.createElement(Person, { key: person._id, person: person });
        })), React.createElement("div", { className: "c-Availability__List" }, React.createElement("div", { className: "c-Availability__ZoomContainer" }, React.createElement("div", { className: "c-Availability__PanContainer" }, React.createElement("div", { className: "c-Availability__LocalOffsetContainer", style: {
            WebkitTransform: "translateX(" + getLocalOffset(today) + "%)"
          } }, React.createElement("div", { className: "c-Availability__Background", style: {
            WebkitTransform: "translateX(-100%)"
          } }, hourMarkers), React.createElement("div", { className: "c-Availability__Background" }, hourMarkers), React.createElement("div", { className: "c-Availability__Background", style: {
            WebkitTransform: "translateX(100%)"
          } }, hourMarkers), this.state.people.map(function (person) {
          var localOffset = getOffset(today, person.time);

          return React.createElement("div", { key: person._id, className: "c-Availability__Row", style: {
              WebkitTransform: "translateX(" + localOffset + "%)"
            } }, React.createElement("div", { className: "c-Availability__Day",
            style: { WebkitTransform: "translateX(-200%)" } }, React.createElement(AvailabilityBar, { person: person, time: dayBefore })), React.createElement("div", { className: "c-Availability__Day",
            style: { WebkitTransform: "translateX(-100%)" } }, React.createElement(AvailabilityBar, { person: person, time: yesterday })), React.createElement("div", { className: "c-Availability__Day",
            style: { WebkitTransform: "translateX(0)" } }, React.createElement(AvailabilityBar, { person: person, time: today })), React.createElement("div", { className: "c-Availability__Day",
            style: { WebkitTransform: "translateX(100%)" } }, React.createElement(AvailabilityBar, { person: person, time: tomorrow })));
        })), React.createElement("div", { className: "c-Availability__CurrentTimeMarker" }))))));
      }
    }
  });
  ...
  _createClass(Person, {
    render: {
      value: function render() {
        ...
        return React.createElement("div", { className: "c-Person" }, React.createElement("div", { className: "c-Person__Avatar o-avatar",
